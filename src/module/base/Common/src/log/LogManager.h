...
private:
	...
	std::string					mConfieFileText = \
        ...
        "log4cplus.appender.ALL_MSGS.File=logs/rtsp.log\n"
        ...
        "log4cplus.appender.WARN_MSGS.File=logs/rtsp.warn\n"
        ...
        "log4cplus.appender.ERROR_MSGS.File=logs/rtsp.error\n"
        ...
        "log4cplus.appender.FATAL_MSGS.File=logs/rtsp.fatal\n"
