...
enum MessageType
{
    ...
    Start_Task_Message,     // 开始任务的消息
    Stop_Task_Message,      // 停止任务的消息
    Get_Task_Message,       // 获取任务的消息
};
...
//  基础消息，不能被实例化
class RTSP_EXPORT BaseMessage : public BaseClass
{
public:
...
// 基础消息的回应
class RTSP_EXPORT BaseResponse : public BaseClass
{
public:
